...
public interface FuelQuoteFormMVP {
    ...
    interface Model {
        ...
        //stores set fields in FuelQuoteHistory
        void storeFieldsInDatabase();
    }
    interface Presenter {
        //checks for any errors in fields
        //also tells model to upload fields to database if no errors
        void onSubmit(String gallons, String address, String date, String s, String t);
        //check for valid number of gallons
        void validateGallons(final String gallons);
